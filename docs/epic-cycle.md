...
Develop a slash command that executes the BMAD Method development cycle sequentially for all stories in an Epic, or a range of Epics. The task sequence is:
